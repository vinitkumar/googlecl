...
"""
# Taken from rietveld trunk (http://code.google.com/p/rietveld), r579
...
# Constants for GoogleCL.
DEFAULT_REVIEWER = 'tom.h.miller@gmail.com'
DEFAULT_CC = 'googlecl-dev@googlegroups.com'
...
group.add_option("-r", "--reviewers", action="store", dest="reviewers",
                 metavar="REVIEWERS", default=DEFAULT_REVIEWER,
                 help="Add reviewers (comma separated email addresses).")
group.add_option("--cc", action="store", dest="cc",
                 metavar="CC", default=DEFAULT_CC,
